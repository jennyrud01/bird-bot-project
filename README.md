...
The model was trained using [TensorFlow Object Detectio API](https://tensorflow-object-detection-api-tutorial.readthedocs.io/en/latest/"TensorFlow Object Detectio API").
